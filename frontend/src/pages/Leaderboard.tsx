        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            ...
            <div className="glass rounded-2xl p-4 md:p-6 text-center border border-gray-400/30 mt-8">
              ...
              <p className="font-display font-bold text-foreground truncate">{leaderboard[1]?.username || '-'}</p>
              <p className="text-2xl md:text-3xl font-display font-bold text-gray-300">{leaderboard[1]?.score ?? '-'}</p>
            </div>
            ...
            <div className="glass rounded-2xl p-4 md:p-6 text-center border-2 border-yellow-400/50 animate-pulse-glow">
              ...
              <p className="font-display font-bold text-foreground truncate">{leaderboard[0]?.username || '-'}</p>
              <p className="text-3xl md:text-4xl font-display font-bold text-yellow-400">{leaderboard[0]?.score ?? '-'}</p>
            </div>
            ...
            <div className="glass rounded-2xl p-4 md:p-6 text-center border border-amber-600/30 mt-8">
              ...
              <p className="font-display font-bold text-foreground truncate">{leaderboard[2]?.username || '-'}</p>
              <p className="text-2xl md:text-3xl font-display font-bold text-amber-600">{leaderboard[2]?.score ?? '-'}</p>
            </div>
          </div>
